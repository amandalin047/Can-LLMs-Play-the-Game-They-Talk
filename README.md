...
## A Linguistic and Behavioral Analysis of Rationality in [Kuhn Poker](https://sites.math.rutgers.edu/~zeilberg/akherim/PokerPapers/Kuhn1951.pdf)
### 🧠 Built With
...
> Note: In the archive code [here](/archive/llms-play-games_past-v.ipynb), a feedback prompt function `FiniteStrategicGame.debrief(game_ended)` is integrated into the session chat. However, this design was not used in the thesis experiments. My future work aims to build on this and further investigate the models’ in-game behavior when explicit feedback prompts are given.
